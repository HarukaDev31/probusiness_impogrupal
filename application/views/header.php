<html lang="en" data-bs-theme="dark">
    ...
    <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/style.css?ver=27.0.0'; ?>">
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-GRS998X0NR"></script>
    <script>
