                  ...
                  <tr>
                    ...
                    <td>
                      <div id="div-agregar_item-<?php echo $row->ID_Producto; ?>" class="d-grid">
                        <button id="btn-agregar_item-<?php echo $row->ID_Producto; ?>" data-id_item="<?php echo $row->ID_Producto . $row->ID_Unidad_Medida; ?>" data-cantidad_item="<?php echo $row->cantidad_item; ?>" data-precio_item="<?php echo $row->precio_item; ?>" data-nombre_item="<?php echo $row->No_Producto; ?>" data-url_imagen_item="<?php echo base_url("assets/images/elefante.png?ver=1.0.0"); ?>" class="btn btn-primary btn-lg btn-agregar_item" type="button">Agregar</button>
                      </div>
                    </td>
                  </tr>
                  <tr>
