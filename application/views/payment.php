    ...
    <div class="row">
      <div class="col-12 col-sm-8 col-md-8">
        <div class="col-12 col-sm-12 col-md-12">
          <h2 class="text-left mb-4">Información de contacto</h2>
          <form>
                ...
                <div class="row">
                  <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" inputmode="numeric" name="Nu_Documento_Identidad" class="form-control required" placeholder="Ingresar" maxlength="15" autocomplete="off">
                  ...
                  <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" inputmode="text" name="No_Entidad" class="form-control required" placeholder="Ingresar" maxlength="100" autocomplete="off">
                      <span class="help-block text-danger" id="error"></span>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" inputmode="text" name="Nu_Celular_Entidad" class="form-control required" placeholder="Ingresar" maxlength="100" autocomplete="off">
                      <span class="help-block text-danger" id="error"></span>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                      <input type="text" inputmode="text" name="Txt_Email_Entidad" class="form-control required" placeholder="Ingresar" maxlength="100" autocomplete="off">
                      <span class="help-block text-danger" id="error"></span>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-12 col-sm-12 col-md-12">
          <!--direccion-->
          <h2 class="text-left mb-4">Dirección</h2>
          <form>
            <div class="card" style="border: none;">
              <div class="card-body shadow p-3 mb-5 bg-body rounded">
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                      <input type="text" inputmode="text" name="Txt_Direccion" class="form-control required" placeholder="Ingresar" maxlength="100" autocomplete="off">
                      <span class="help-block text-danger" id="error"></span>
                    </div>
                  </div>
                </div>
